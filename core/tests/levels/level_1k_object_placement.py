...
def test_surface_positions():
    ...
    ops.add_asset("table", relative_to=(3, 0, 0), is_tracked=True)
    ops.add_robot("stretch", position=(0, 0, 0), orientation="east")

    ops.add_asset("apple", asset_id="apple_tl", relative_to="table", relation="on_top", surface_position="top_left", is_tracked=True)
    ops.add_asset("apple", asset_id="apple_tr", relative_to="table", relation="on_top", surface_position="top_right", is_tracked=True)
    ops.add_asset("apple", asset_id="apple_bl", relative_to="table", relation="on_top", surface_position="bottom_left", is_tracked=True)
    ops.add_asset("apple", asset_id="apple_br", relative_to="table", relation="on_top", surface_position="bottom_right", is_tracked=True)
    ops.add_asset("apple", asset_id="apple_c", relative_to="table", relation="on_top", surface_position="center", is_tracked=True)
...
def test_cardinal_orientations_north():
    ...
    ops.add_asset("table", relative_to=(3, 0, 0), is_tracked=True)
    ops.add_asset("apple", relative_to="table", relation="on_top", is_tracked=True)
...
def test_stacking_chain():
    ...
    ops.add_asset("wood_block", asset_id="block1", relative_to="table", relation="on_top", surface_position="center", is_tracked=True)
    ops.add_asset("wood_block", asset_id="block2", relative_to="block1", relation="on_top", surface_position="center", is_tracked=True)
    ops.add_asset("wood_block", asset_id="block3", relative_to="block2", relation="on_top", surface_position="center", is_tracked=True)
...
def test_horizontal_arrangement():
    ...
    ops.add_asset("table", relative_to=(4, 0, 0), is_tracked=True)
    ops.add_robot("stretch", position=(0, 0, 0), orientation="east")

    ops.add_asset("apple", asset_id="obj1", relative_to="table", relation="on_top", surface_position="center", is_tracked=True)
    ops.add_asset("banana", asset_id="obj2", relative_to="obj1", relation="next_to", distance=0.15, is_tracked=True)
    ops.add_asset("orange", asset_id="obj3", relative_to="obj2", relation="next_to", distance=0.15, is_tracked=True)
    ops.add_asset("mug", asset_id="obj4", relative_to="obj3", relation="next_to", distance=0.15, is_tracked=True)
...
def test_containment_hierarchy():
    ...
    ops.add_asset("bowl", relative_to="table", relation="on_top", surface_position="center", is_tracked=True)
    ops.add_asset("strawberry", asset_id="strawberry", relative_to="bowl", relation="inside", surface_position="bottom", is_tracked=True)
    ops.add_asset("lemon", asset_id="lemon", relative_to="bowl", relation="inside", surface_position="bottom", is_tracked=True)
    ops.add_asset("peach", asset_id="peach", relative_to="bowl", relation="inside", surface_position="bottom", is_tracked=True)
...
def test_facing_validation():
    ...
    ops.add_asset("apple", asset_id="target1", relative_to="table", relation="on_top", surface_position="center", is_tracked=True)
    ops.add_asset("banana", asset_id="target2", relative_to="table", relation="on_top", surface_position="top_left", is_tracked=True)
    ops.add_asset("orange", asset_id="target3", relative_to="table", relation="on_top", surface_position="bottom_right", is_tracked=True)
...
def test_offset_placement():
    ...
    ops.add_asset("apple", asset_id="center", relative_to="table", relation="on_top", surface_position="center", is_tracked=True)
    ops.add_asset("banana", asset_id="offset_x", relative_to="center", relation="on_top", offset=(0.2, 0, 0), is_tracked=True)
    ops.add_asset("orange", asset_id="offset_y", relative_to="center", relation="on_top", offset=(0, 0.2, 0), is_tracked=True)
    ops.add_asset("mug", asset_id="offset_xy", relative_to="center", relation="on_top", offset=(0.15, 0.15, 0), is_tracked=True)
...
def test_robot_grasp_alignment():
    ...
    ops.add_asset("table", relative_to=(2, 0, 0), is_tracked=True)
